...
class postrecycler2 extends RecyclerView.Adapter<postrecycler2.myviewholder>{
    List<postinfo2> collectdata;ImageLoader imageLoader;
    ...
    RequestQueue requestQueue;SharedPreferences sharedPreferences;int previousposition=0;
    ...
    public postrecycler2(Context context, List<postinfo2> collectdata) {
    ...
    public myviewholder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view=inflater.inflate(R.layout.post2,viewGroup,false);
       ...
       final String s=collectdata.get(i).post;
        if(s.endsWith("jpg")||s.endsWith("png")||s.endsWith("jpeg")){
         ...
         // myviewholder.videoView.setMediaController(mc);
            ...
            myviewholder.videoView.setVisibility(View.INVISIBLE);
            myviewholder.imageView2.setVisibility(View.INVISIBLE);
            myviewholder.youTubeThumbnailView.setVisibility(View.VISIBLE);
...
return diff;
    ...
    private void showlikes(postrecycler2.myviewholder myviewholder, int i) {
    ...
    private void like(final String postid, final int no, final CircleImageView like, final CircleImageView unlike, final postrecycler2.myviewholder myviewholder, final int i) {
        requestQueue= Volley.newRequestQueue(context);
...
public void setfilter(List<postinfo2> data){
